...
namespace lfs::vis {
    ...
    AppStore::AppStore()
        : iteration(store_, Field::Iteration, "iteration", 0),
          ...
          transform_skipped_locked_targets(store_,
                                           Field::TransformSkippedLockedTargetsValue,
                                           "transform_skipped_locked_targets",
                                           0),
          transform_skipped_unsupported_targets(store_,
                                                Field::TransformSkippedUnsupportedTargetsValue,
                                                "transform_skipped_unsupported_targets",
                                                0),
